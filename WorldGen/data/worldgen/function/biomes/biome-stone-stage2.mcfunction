...
execute if score Temp Vars <= SeaLevel Vars run execute if score NoiseOutput Vars matches 1001..1100 run place feature kelp
...
execute if score NoiseOutput Vars matches 1101..1110 if block ~ ~ ~ #dirt run place feature flower_plain
execute if score NoiseOutput Vars matches 2000..2020 if block ~ ~ ~ #dirt unless block ~ ~3 ~1 #logs unless block ~1 ~3 ~1 #logs unless block ~1 ~3 ~ #logs unless block ~1 ~3 ~-1 #logs unless block ~ ~3 ~-1 #logs unless block ~-1 ~3 ~-1 #logs unless block ~-1 ~3 ~ #logs unless block ~-1 ~3 ~1 #logs run place feature oak ~ ~1 ~
