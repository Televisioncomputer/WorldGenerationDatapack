...
scoreboard players operation NoiseOutput Vars /= WorldHeightCoEfficient Vars
...
scoreboard players operation Temp Vars = NoiseSteps Vars
#scoreboard players remove Temp Vars 1
...
#tellraw @a ["",{"text":"Noise+- X: "},{"score":{"name":"X","objective":"Vars"}},{"text":" Z: "},{"score":{"name":"Z","objective":"Vars"}}]
#tellraw @a ["",{"text":"\nNoiseSteps: "},{"score":{"name":"NoiseSteps","objective":"Vars"}}]
execute if score NoiseOutput Vars > RealWorldHeight Vars run tellraw @a ["",{"score":{"name":"NoiseOutput","objective":"Vars"}},{"text":"\nNoise--: "},{"score":{"name":"Noise--","objective":"Vars"}},{"text":"\nNoise+-: "},{"score":{"name":"Noise+-","objective":"Vars"}},{"text":"\nNoise-+: "},{"score":{"name":"Noise-+","objective":"Vars"}},{"text":"\nNoise++: "},{"score":{"name":"Noise++","objective":"Vars"}}]
