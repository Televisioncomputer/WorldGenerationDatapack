...
scoreboard players set SeaLevel Vars 128
scoreboard players set SeaDepth Vars 64
...
scoreboard players set Noise1Steps Vars 100
...
scoreboard players set BiomeTemperatureNoiseSteps Vars 144
scoreboard players set BiomeHumidityNoiseSteps Vars 102
...
scoreboard players set CaveMax Vars 75
scoreboard players set CaveMaxSize Vars 50
scoreboard players set CaveNoiseSteps1 Vars 240
scoreboard players set CaveNoiseSteps2 Vars 140
scoreboard players set CaveNoiseSteps3 Vars 70
