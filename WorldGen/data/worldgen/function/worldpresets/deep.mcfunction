...
scoreboard players set SeaLevel Vars 280
scoreboard players set SeaDepth Vars 20
...
scoreboard players set CaveChance Vars 80
scoreboard players set CaveMax Vars 90
scoreboard players set CaveMaxSize Vars 100
scoreboard players set CaveNoiseSteps1 Vars 300
scoreboard players set CaveNoiseSteps2 Vars 160
scoreboard players set CaveNoiseSteps3 Vars 80
