...
scoreboard players set WorldHeight Vars 64
scoreboard players set SeaLevel Vars 32
scoreboard players set SeaDepth Vars 16
...
scoreboard players set Noise1Steps Vars 400
scoreboard players set Noise2Steps Vars 222
scoreboard players set Noise3Steps Vars 124
scoreboard players set Noise4Steps Vars 112
scoreboard players set Noise5Steps Vars 20
scoreboard players set BiomeTemperatureNoiseSteps Vars 402
scoreboard players set BiomeHumidityNoiseSteps Vars 400
...
scoreboard players operation OreCoEfficient Vars /= 2 Vars
...
scoreboard players set CaveChance Vars 50
scoreboard players set CaveMax Vars 50
scoreboard players set CaveMaxSize Vars 10
